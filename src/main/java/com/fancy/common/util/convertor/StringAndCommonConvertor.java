...
public class StringAndCommonConvertor {
    ...
    public static class StringToCommon implements Convertor {
        ...
        protected Boolean booleanConvert(Object value) {
            ...
            throw new RuntimeException("Unsupported convert: [" + String.class + "," + Boolean.class.getName()
                                           + "]");
        }
        ...
        protected Character charConvert(Object value) {
            ...
            throw new RuntimeException("Unsupported convert: [" + String.class + "," + Character.class.getName()
                                           + "]");
        }
