...
public class CommonAndCommonConvertor {
     ...
     * common <-> common对象的转化
     */
    public static class CommonToCommon implements Convertor {
        ...
        private Object toCommon(Class srcClass, Class targetClass, Number value) {
            ...
            if (targetClass == Integer.class || targetClass == int.class) {
                ...
                if (longValue > Integer.MAX_VALUE) {
                    throw new RuntimeException(srcClass.getName() + " value '" + value + "' is too large for "
                                                   + targetClass.getName());
                }
                if (longValue < Integer.MIN_VALUE) {
                    throw new RuntimeException(srcClass.getName() + " value '" + value + "' is too small "
                                                   + targetClass.getName());
                }
            ...
            if (targetClass == Float.class || targetClass == float.class) {
                ...
                if (doubleValue < Float.MIN_VALUE) {
                    throw new RuntimeException(srcClass.getName() + " value '" + value + "' is too small for "
                                                   + targetClass.getName());
                }
            ...
            throw new RuntimeException("Unsupported convert: [" + srcClass.getName() + "," + targetClass.getName()
                                           + "]");
        }
        ...
        public Object convert(Object src, Class targetClass) {
            ...
            throw new RuntimeException("Unsupported convert: [" + src + "," + targetClass.getName() + "]");
        }
    }
}
